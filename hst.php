...
<div class="dia"></div>
            <div class="cardsoon">
                <div class="card1"><img src="image/granm.jpeg" width="200px" height="240px"></div> <!--image-->
                <!--col1-->
                <div class="place">
                    <h1>Grand Egyptian Museum</h1>
                    <h3>Giza</h3>
                </div> <!--place--> <!--col2 row1-->
                <div class="details"> <!--details--> <!--col2 row2-->
                    <span class="soon">
                        <h2>comming soon</h2>
                    </span>
                </div>
                <span class="prc">Price $$$</span>
                <button class="btn" s><a>Visit it</a></button> <!--button--> <!--col3-->
            </div>
        </div>
        <?php
